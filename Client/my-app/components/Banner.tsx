...
function Banner() {
  return (
    <div className='flex flex-col md:space-y-10 space-y-3 items-center md:py-10 py-5 text-center align-middle z-10'>
        ...
        <div className='bg-[#252526] md:rounded-3xl rounded-xl md:h-16 lg:w-3/5 w-4/5 z-10 flex md:flex-row flex-wrap md:flex-nowrap p-3 md:p-10 md:space-x-2 space-y-5 md:space-y-0 align-middle m-auto md:text-xl text-sm items-center '> 
